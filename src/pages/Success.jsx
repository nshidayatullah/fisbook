    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-xl shadow-gray-200/50 outline-1 -outline-offset-1 outline-gray-200">
            <div className="space-y-5">
              ...
              {/* Schedule Card */}
              <div className="mt-2 rounded-xl bg-emerald-50 p-5 outline-1 -outline-offset-1 outline-emerald-200">
