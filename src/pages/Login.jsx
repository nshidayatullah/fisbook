      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white">PhysioBook Login</h2>
            <p className="mt-2 text-gray-400">Masuk ke sistem manajemen fisioterapi</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="mt-2 block w-full rounded-lg bg-white/5 px-4 py-3 text-white border border-white/10 placeholder:text-gray-500 focus:border-blue-500 focus:bg-white/10 focus:ring-1 focus:ring-blue-500"
