              ...
              <tbody className="divide-y divide-white/5">
                {loading
                  ...
                  : filteredCodes.map((code) => (
                      <tr key={code.id} className={`hover:bg-white/5 transition-colors ${code.isUsed ? "opacity-60" : ""}`}>
                        {/* Kode Column */}
                        ...
                        {/* Status Column */}
                        <td className="px-6 py-4 whitespace-nowrap">
                          {code.isUsed ? <span className="inline-flex items-center rounded-full bg-white/5 px-3 py-1 text-xs font-medium text-gray-500">Terpakai</span> : <span className="inline-flex items-center rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-400">Tersedia</span>}
                        </td>
